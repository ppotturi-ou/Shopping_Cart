...
Members: jonatancogiel@oakland.edu
...
****************************************************************************************************/
void LCD_CmdWrite( uint8_t data)
{
...
void LCD_DisplayFloatNumber(double v_floatNum_f32)
{
    ...
    v_temp_u32 = v_floatNum_f32 * 100;
    LCD_DisplayNumber(C_DECIMAL_U8,(v_temp_u32+1),2);
}
#endif
